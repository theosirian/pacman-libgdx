...
public class Pacman extends Entity {
	...
	private final Queue<Direction> stepQueue;
	...
	public Pacman(int x, int y, TiledMapTileLayer collisionLayer, Queue<Direction> stepQueue, Vector2 aiTargetPosition) {
		...
		this.aiTargetPosition = aiTargetPosition;
	}
